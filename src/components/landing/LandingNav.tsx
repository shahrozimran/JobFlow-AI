    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            href="/dashboard"
            className="px-5 py-2 rounded-full gradient-premium text-white text-sm font-semibold hover:opacity-90 transition-all shadow-md hover:shadow-lg hover:shadow-accent-blue/20 active:scale-95"
          >
            Get Started
          </Link>
        </div>
          ...
          >
            <nav className="flex flex-col gap-1 p-4">
              ...
              <Link
                href="/dashboard"
                onClick={() => setIsOpen(false)}
                className="mt-2 text-center py-3 mx-4 rounded-full gradient-premium text-white font-semibold hover:opacity-90 transition-all shadow-md"
              >
                Get Started Free
              </Link>
            </nav>
